...
<head>
    ...
    <title>Solaria Indonesia | Twitter, Instagram, Facebook, TikTok | Linktree</title>
    <link rel = "icon" href = "favicon.ico.png" type = "image/x-icon">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
</head>
<body>
    <div>
        <img src="{{ asset('./image/logo solaria.png')}}" class="frans-logo-tengah">
    </div>

    <div class="frans-nama-tengah">
        Solaria Indonesia
    </div>

    <a href="https://drive.google.com/file/d/1692PLTHFg-vjSCypHc5KYL1NYan5dvaQ/view" target="_blank" class="frans-text">
        Menu
    </a>

    <a href="https://solariaresto.co.id/" target="_blank" class="frans-text">
        Website
    </a>

    <a href="https://gofood.link/a/xzEuMAy#" target="_blank" class="frans-text">
        Delivery GoFood
    </a>

    <a href="https://tinyurl.com/rh64km22" target="_blank" class="frans-text">
        Delivery GrabFood
    </a>

    <a href="https://shopee.co.id/now-food/storeListing/4871?stm_medium=referral&stm_source=https%3A%2F%2Flinktr.ee%2" target="_blank" class="frans-text">
        Delivery ShoppeFood
    </a>

    <div class="frans-center">
        <a href ="https://www.facebook.com/Solaria-Indonesia-24813128533967" target="_blank">
            <img src="{{ asset('./image/facebook-5-128.png')}}" class="frans-icon">
        </a>

        <a href ="https://twitter.com/SolariaID" target="_blank">
            <img src="{{ asset('./image/twitter-128.png')}}" class="frans-icon">
        </a>

        <a href ="https://instagram.com/solaria.indonesia" target="_blank">
            <img src="{{ asset('./image/icons8-instagram-150.png')}}" class="frans-icon">
        </a>

        <a href ="https://tiktok.com/@solaria.indonesia" target="_blank">
            <img src="{{ asset('./image/icons8-tik-tok-96.png')}}" class="frans-icon">
        </a>

        <a href ="mailto:cs@solariaresto.com" target="_blank">
            <img src="{{ asset('./image/icons8-mail-96.png')}}" class="frans-icon">
        </a>

    </div>
    <a href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_content=solaria.indonesia">
        <div class="frans-icon-linktree">
            <svg height="3%" viewBox="0 0 80 17" style="display:block;width:auto" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M65.7852 5.33374H69.6615L66.9058 2.70668L68.4306 1.13901L71.0577 3.83956V0H73.3357V3.83956L75.9627 1.14513L77.4863 2.70668L74.7319 5.32762H78.607V7.49541H74.7098L77.4827 10.1898L75.9627 11.7208L72.1967 7.93631L68.4306 11.7208L66.9058 10.196L69.6798 7.50153H65.7852V5.33374ZM71.0515 10.6062H73.3296V15.7502H71.0515V10.6062Z" fill="#FFFFFF"></path>
            </svg>
        </div>
    </a>
</body>
